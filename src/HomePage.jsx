...
<section className="relative h-[420px] md:h-[520px] lg:h-[620px] w-full overflow-hidden">
  ...
  <div className="relative z-10 flex h-full items-center  justify-center ">
    <div className="max-w-4xl text-center">
      ...
      <div className="mt-4">
        <span className="inline-block w-full border-white border py-2 rounded-full bg-black/70 font-[serif] text-3xl md:text-6xl lg:text-7xl text-cyan-300 tracking-wide drop-shadow-2xl">
