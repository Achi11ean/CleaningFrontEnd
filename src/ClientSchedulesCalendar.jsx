...
const myWeeklyEvents = useMemo(() => {
  return events
    ...
    .sort((a, b) => a.start - b.start);
}, [events, weekStart, weekEnd, myAdminId]);
      ...
      {selectedEvent && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-lg space-y-4">
            ...
            <div className="space-y-2">
              <p><strong>Name:</strong> {selectedEvent.client.first_name} {selectedEvent.client.last_name}</p>
      <p>
  <strong>Email:</strong>{" "}
...
<p>
  ...
  {selectedEvent.client.address ? (
    ...
    "—"
              ...
              <p><strong>Schedule Type:</strong> {selectedEvent.schedule_type}</p>
<p>
  <strong>Time:</strong>{" "}
